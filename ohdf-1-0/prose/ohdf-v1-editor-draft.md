...
#### This stage:
https://docs.oasis-open.org/ohdf/ohdf/v4.0/csd01/oohdf-v1.0-csd01.md (Authoritative) \
https://docs.oasis-open.org/ohdf/ohdf/v4.0/csd01/oohdf-v1.0-csd01.html \
https://docs.oasis-open.org/ohdf/ohdf/v4.0/csd01/oohdf-v1.0-csd01.pdf

#### Previous stage:

#### Latest stage:
https://docs.oasis-open.org/ohdf/ohdf/v1.0/ohdf-v1.0.md (Authoritative) \
https://docs.oasis-open.org/ohdf/ohdf/v1.0/ohdf-v1.0.html \
https://docs.oasis-open.org/ohdf/ohdf/v1.0/ohdf-v1.0.pdf

#### Technical Committee:
[OASIS Heimdall Format (OHDF) TC](https://www.oasis-open.org/committees/ohdf/)

#### Chairs:

Aaron Lippold (alippold@mitre.org), [Mitre Corporation](https://www.mitre.org/) \
Mike Fraser (mike.fraser@sophos.com), [Sophos Ltd](https://www.sophos.com/)

#### Editors:

A Given Family (roster1.email@addr.es), [RosterOrgaName1](https://roster-given-url1.org) \
Another Given Family (roster2.email@addr.es), [RosterOrgaName2](https://roster-given-url2.org) \
Yet Another Given Family (roster3.email@addr.es), [RosterOrgaName3](https://roster-given-url3.org)

#### Additional artifacts:
This document is one component of a Work Product that also includes:
* OHDF JSON Schema Aspect1 Version 1.0: https://docs.oasis-open.org/ohdf/ohdf/v1.0/csd01/ohdf-aspect1.json
* OHDF JSON Schema Aspect2 Version 1.0: https://docs.oasis-open.org/ohdf/ohdf/v1.0/csd01/ohdf-aspect2.json
* OHDF JSON Schema Aspect3 Version 1.0: https://docs.oasis-open.org/ohdf/ohdf/v1.0/csd01/ohdf-aspect3.json
* `(Note: Any normative computer language definitions that are part of the Work Product, such as XML instances, schemas and Java(TM) code, including fragments of such, must be (a) well formed and valid, (b) provided in separate plain text files, (c) referenced from the Work Product; and (d) where any definition in these separate files disagrees with the definition found in the specification, the definition in the separate file prevails. Remove this note before submitting for publication.)`

#### Related work:
This specification is related to: N/A

#### Abstract:
This OASIS Heimdall Format (OHDF) specification defines a common format for exchanging normalized security data between cybersecurity tools.

#### Status:
This document was last revised or approved by the OASIS Heimdall Data Format (OHDF) TC on the above date. The level of approval is also listed above. Check the "Latest stage" location noted above for possible later revisions of this document. Any other numbered Versions and other technical work produced by the Technical Committee (TC) are listed at https://www.oasis-open.org/committees/tc_home.php?wg_abbrev=ohdf#technical.

TC members should send comments on this specification to the TC's email list. Others should send comments to the TC's public comment list, after subscribing to it by following the instructions at the "[Send A Comment](https://www.oasis-open.org/committees/comments/index.php?wg_abbrev=ohdf)" button on the TC's web page at https://www.oasis-open.org/committees/ohdf/.

This specification is provided under the [Non-Assertion IPR mode](https://www.oasis-open.org/policies-guidelines/ipr/#Non-Assertion-Mode) of the [OASIS IPR Policy](https://www.oasis-open.org/policies-guidelines/ipr/), the mode chosen when the Technical Committee was established. For information on whether any patents have been disclosed that may be essential to implementing this specification, and any offers of patent licensing terms, please refer to the Intellectual Property Rights section of the TC's web page (https://www.oasis-open.org/committees/ohdf/ipr.php).
...
_OHDF Version 1.0_.
Edited by A Given Family, Another Given Family, and Yet Another Given Family. 19 May 2023. OASIS Committee Specification Draft 01.
https://docs.oasis-open.org/ohdf/ohdf/v1.0/csd01/ohdf-v1.0-csd01.html.
Latest stage: https://docs.oasis-open.org/ohdf/ohdf/v1.0/ohdf-v1.0.html.
...
Here is a customized command line which will generate HTML from this markdown file (named ohdf-v1.0-csd01.md):

pandoc -f gfm -t html ohdf-v1.0-csd01.md -c https://docs.oasis-open.org/templates/css/markdown-styles-v1.7.3a.css --toc --toc-depth=5 -s -o ohdf-v1.0-csd01.html --metadata title="OHDF Version 1.0"
